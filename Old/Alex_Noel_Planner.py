...
def cs_science_req():
    ...
    cs_biology = [['CH111', 'CH113', 'CH221', 'CH224'], 'BI211',
                  ['BI212', 'BI213']]  # 1 from first sublist, 1 from second sublist
    ...
    if science_category == 'GEOGRAPHY':
        ...
        science_selection = (input(
            "Which of the two classes would you like to select (Enter TWO numbers separated by a comma: 1,2,3 ): ")).upper()
    ...
    if science_category == 'GEOLOGICAL SCIENCES':
        ...
        if science_selection != '1' and science_selection != '2':
            ...
            return cs_geological_sciences[int(science_selection) - 1]
    ...
    if science_category == 'BIOLOGY':
        ...
        class_list = []
        science_selection = (
            input('Which class would you like to take from: CH111, CH113, CH221, CH224 (enter 1,2,3 or 4):')).upper()
...
def main():
    cs_classes = ["CS122", "CS210", "CS211", "CS212", "CS313", "CS314", "CS315", "CS330", "CS415", "CS415", "CS422",
                  "CS425"]
